...
factoryRsyslogPkgRpmBuild.addStep(ShellCommand(command=["bash", "-c", "if ./rpmmaker.sh; then echo ok;cat /var/lib/mock/epel-9-x86_64/result/build.log; exit 0; else cat /var/lib/mock/epel-8-x86_64/result/build.log; exit 1; fi"], haltOnFailure=True, workdir="/home/pkg/rsyslog-pkg-rhel-centos/", env={'RPM_SPEC': 'v8-stable-el7', "RPM_PLATFORM":"epel-9", "RPM_ARCH":"x86_64", "RPM_REPO":"testing"}, logfiles={"root.log": "/var/lib/mock/epel-9-x86_64/result/root.log", "build.log": "/var/lib/mock/epel-9-x86_64/result/build.log", "state.log": "/var/lib/mock/epel-9-x86_64/result/state.log"}, name="build epel-9/x86_64 rpms"))
...
factoryRsyslogPkgRealRpmBuild.addStep(ShellCommand(command=["bash", "-c", "cat ./rpmbuild/SPECS/v8-stable-el7.spec"], workdir="/home/pkg/rsyslog-pkg-rhel-centos/", haltOnFailure=True, name="cat SPECFILE"))
# - BUILD RPMS
# EPEL7 SUPPORT DROPPED     # factoryRsyslogPkgRealRpmBuild.addStep(ShellCommand(command=["bash", "-c", "if ./rpmmaker.sh; then echo ok;cat /var/lib/mock/epel-7-x86_64/result/build.log; exit 0; else cat /var/lib/mock/epel-7-x86_64/result/build.log; exit 1; fi"], haltOnFailure=True, workdir="/home/pkg/rsyslog-pkg-rhel-centos/", env={'RPM_SPEC': 'v8-stable-el7', "RPM_PLATFORM":"epel-7", "RPM_ARCH":"x86_64", "RPM_REPO":"v8-stable"}, logfiles={"root.log": "/var/lib/mock/epel-7-x86_64/result/root.log", "build.log": "/var/lib/mock/epel-7-x86_64/result/build.log", "state.log": "/var/lib/mock/epel-7-x86_64/result/state.log"}, name="build epel-7/x86_64 rpms"))
factoryRsyslogPkgRealRpmBuild.addStep(ShellCommand(command=["bash", "-c", "if ./rpmmaker.sh; then echo ok;cat /var/lib/mock/epel-8-x86_64/result/build.log; exit 0; else cat /var/lib/mock/epel-8-x86_64/result/build.log; exit 1; fi"], haltOnFailure=True, workdir="/home/pkg/rsyslog-pkg-rhel-centos/", env={'RPM_SPEC': 'v8-stable-el7', "RPM_PLATFORM":"epel-8", "RPM_ARCH":"x86_64", "RPM_REPO":"v8-stable"}, logfiles={"root.log": "/var/lib/mock/epel-8-x86_64/result/root.log", "build.log": "/var/lib/mock/epel-8-x86_64/result/build.log", "state.log": "/var/lib/mock/epel-8-x86_64/result/state.log"}, name="build epel-8/x86_64 rpms"))
factoryRsyslogPkgRealRpmBuild.addStep(ShellCommand(command=["bash", "-c", "if ./rpmmaker.sh; then echo ok;cat /var/lib/mock/epel-9-x86_64/result/build.log; exit 0; else cat /var/lib/mock/epel-8-x86_64/result/build.log; exit 1; fi"], haltOnFailure=False, workdir="/home/pkg/rsyslog-pkg-rhel-centos/", env={'RPM_SPEC': 'v8-stable-el7', "RPM_PLATFORM":"epel-9", "RPM_ARCH":"x86_64", "RPM_REPO":"v8-stable"}, logfiles={"root.log": "/var/lib/mock/epel-9-x86_64/result/root.log", "build.log": "/var/lib/mock/epel-9-x86_64/result/build.log", "state.log": "/var/lib/mock/epel-9-x86_64/result/state.log"}, name="build epel-9/x86_64 rpms"))
factoryRsyslogPkgRealRpmBuild.addStep(ShellCommand(command=["bash", "-c", "if ./rpmmaker.sh; then echo ok;cat /var/lib/mock/rhel-7-x86_64/result/build.log; exit 0; else cat /var/lib/mock/rhel-7-x86_64/result/build.log; exit 1; fi"], haltOnFailure=False, workdir="/home/pkg/rsyslog-pkg-rhel-centos/", env={'RPM_SPEC': 'v8-stable-el7', "RPM_PLATFORM":"rhel-7", "RPM_ARCH":"x86_64", "RPM_REPO":"v8-stable"}, logfiles={"root.log": "/var/lib/mock/rhel-7-x86_64/result/root.log", "build.log": "/var/lib/mock/rhel-7-x86_64/result/build.log", "state.log": "/var/lib/mock/rhel-7-x86_64/result/state.log"}, name="build rhel-7/x86_64 rpms"))
factoryRsyslogPkgRealRpmBuild.addStep(ShellCommand(command=["bash", "-c", "if ./rpmmaker.sh; then echo ok;cat /var/lib/mock/rhel-8-x86_64/result/build.log; exit 0; else cat /var/lib/mock/rhel-8-x86_64/result/build.log; exit 1; fi"], haltOnFailure=True, workdir="/home/pkg/rsyslog-pkg-rhel-centos/", env={'RPM_SPEC': 'v8-stable-el7', "RPM_PLATFORM":"rhel-8", "RPM_ARCH":"x86_64", "RPM_REPO":"v8-stable"}, logfiles={"root.log": "/var/lib/mock/rhel-8-x86_64/result/root.log", "build.log": "/var/lib/mock/rhel-8-x86_64/result/build.log", "state.log": "/var/lib/mock/rhel-8-x86_64/result/state.log"}, name="build rhel-8/x86_64 rpms"))
factoryRsyslogPkgRealRpmBuild.addStep(ShellCommand(command=["bash", "-c", "if ./rpmmaker.sh; then echo ok;cat /var/lib/mock/rhel-9-x86_64/result/build.log; exit 0; else cat /var/lib/mock/rhel-8-x86_64/result/build.log; exit 1; fi"], haltOnFailure=True, workdir="/home/pkg/rsyslog-pkg-rhel-centos/", env={'RPM_SPEC': 'v8-stable-el7', "RPM_PLATFORM":"rhel-9", "RPM_ARCH":"x86_64", "RPM_REPO":"v8-stable"}, logfiles={"root.log": "/var/lib/mock/rhel-9-x86_64/result/root.log", "build.log": "/var/lib/mock/rhel-9-x86_64/result/build.log", "state.log": "/var/lib/mock/rhel-9-x86_64/result/state.log"}, name="build rhel-9/x86_64 rpms"))
